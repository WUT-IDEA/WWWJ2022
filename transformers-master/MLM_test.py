...
config = ElectraConfig.from_pretrained("hfl/chinese-electra-180g-base-discriminator", num_labels=num_labels,
                                       hidden_dropout_prob=hidden_dropout_prob)
# model = ElectraForSequenceClassification.from_pretrained("hfl/chinese-electra-180g-base-discriminator", config=config)
model = ElectraForMaskedLM.from_pretrained("hfl/chinese-electra-180g-base-discriminator", config=config)
model.to(device)


# 加载数据集
data_path = ""
sentiment_train_set = SentimentDataset(data_path + "data_train2.csv")
